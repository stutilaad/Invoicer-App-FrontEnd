<template>
  <section class="section">
    <h1 class="title has-text-centered has-text-primary">Choose a Template for your Invoice.</h1>
    <br />
    <div class="columns">
      <div class="column has-text-centered">
        <a href="/#/dashboard/addinvoice-template-one/">
